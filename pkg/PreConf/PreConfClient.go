...
func (_PreConf *PreConfCaller) UserRegistry(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _PreConf.contract.Call(opts, &out, "userRegistry")
...
//
// Solidity: function userRegistry() view returns(address)
func (_PreConf *PreConfSession) UserRegistry() (common.Address, error) {
	return _PreConf.Contract.UserRegistry(&_PreConf.CallOpts)
}

// UserRegistry is a free data retrieval call binding the contract method 0x5c7460d6.
//
// Solidity: function userRegistry() view returns(address)
func (_PreConf *PreConfCallerSession) UserRegistry() (common.Address, error) {
	return _PreConf.Contract.UserRegistry(&_PreConf.CallOpts)
}
...
func (_PreConf *PreConfTransactor) UpdateUserRegistry(opts *bind.TransactOpts, newUserRegistry common.Address) (*types.Transaction, error) {
	return _PreConf.contract.Transact(opts, "updateUserRegistry", newUserRegistry)
}

// UpdateUserRegistry is a paid mutator transaction binding the contract method 0x2e37d826.
//
// Solidity: function updateUserRegistry(address newUserRegistry) returns()
func (_PreConf *PreConfSession) UpdateUserRegistry(newUserRegistry common.Address) (*types.Transaction, error) {
	return _PreConf.Contract.UpdateUserRegistry(&_PreConf.TransactOpts, newUserRegistry)
}

// UpdateUserRegistry is a paid mutator transaction binding the contract method 0x2e37d826.
//
// Solidity: function updateUserRegistry(address newUserRegistry) returns()
func (_PreConf *PreConfTransactorSession) UpdateUserRegistry(newUserRegistry common.Address) (*types.Transaction, error) {
	return _PreConf.Contract.UpdateUserRegistry(&_PreConf.TransactOpts, newUserRegistry)
}
